...
public class CheckersLayout extends TableLayout {
    ...
    public void animateMove(Move move) {
        ...
        switch (imgID) {
            case 1: iconid = myGame.getBlackNormalIconId(); break;
            case 2: iconid = myGame.getWhiteNormalIconId(); break;
            case 3: iconid = myGame.getBlackKingIconId();   break;
            default:iconid = myGame.getWhiteKingIconId();   break;

        }
        cellTo.setImageResource(iconid);
